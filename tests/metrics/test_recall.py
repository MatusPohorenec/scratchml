...
class Test_Recall(unittest.TestCase):
    ...
    def test_3(self):
        ...
        with self.assertRaises(ValueError):
            recall(y, sklr_prediction, average="invalid")

    def test_4(self):
        """
        Test the Recall with average set to 'macro' on a multi-class dataset.
        """
        X, y = generate_classification_dataset(
            n_features=10, n_samples=10000, n_classes=5
        )
    ...
    def test_5(self):
        """
        Test the Recall with average set to 'weighted' on a multi-class dataset.
        """
        X, y = generate_classification_dataset(
            n_features=10, n_samples=10000, n_classes=5
        )
